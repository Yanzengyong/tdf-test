...
Mock.mock(/\/verification-code/, "get", loginAPI.getVerification);
Mock.mock(/\/verification-code/, "post", loginAPI.checkVertification);
Mock.mock(/\/cahnge-password/, "post", loginAPI.changePassword);
Mock.mock(/\/register/, "post", loginAPI.register);
Mock.mock(/\/login/, "post", loginAPI.auth);
Mock.mock(/\/logout/, "get", loginAPI.logout);
Mock.mock(/\/web-user-details/, "get", loginAPI.userdetails);
...
Mock.mock(
  /\/sys\/group-user\/findUsersByGroupId/,
  "get",
  groupAPI.queryAllGroupUsers
);
...
Mock.mock(
  /\/sys\/role-user\/findRolesByUserId/,
  "get",
  userAPI.queryAllUserRoles
);
Mock.mock(
  /\/sys\/dept-user\/findDeptInfosByUserId/,
  "get",
  userAPI.queryAllUserDepts
);
Mock.mock(
  /\/sys\/group-user\/findGroupsByUserId/,
  "get",
  userAPI.queryAllUserGroups
);
...
Mock.mock(
  /\/sys\/data-item-type\/search\/all/,
  "get",
  dataItemTypeAPI.queryAll
);
...
Mock.mock(/\/sample\/student\/search/, 'post', studentAPI.query)
Mock.mock(/\/sample\/student\//, 'post', studentAPI.add)
Mock.mock(/\/sample\/student\/deleteByIds/, 'delete', studentAPI.deleteStudent)
Mock.mock(/\/sample\/student\//, 'put', studentAPI.updateStudent)
Mock.mock(/\/sample\/schoolgrade\/find-all-tree/, 'get', studentAPI.queryAllUserGroups)
Mock.mock(/\/sample\/schoolgrade\//, 'post', studentAPI.addGrade)
Mock.mock(/\/sample\/schoolgrade\//, 'put', studentAPI.editGrade)
Mock.mock(/\/sample\/schoolgrade\//, 'delete', studentAPI.delGrade)
